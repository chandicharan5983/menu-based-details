...
export class ToolTipDirective {
  ...
  // Host listners for all the mouse events
  ...
  //method to show the tooltip object
  show() {
    if (!this.showTooltip) {
      return;
    }
...
//method to create the tooltip object
  create() {
...
// function to decide the position of the tooltip element
  setPosition() {
